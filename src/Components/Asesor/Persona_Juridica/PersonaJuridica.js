  ...
  return (
    <div className="FONDO" id="">
      ...
      <form className="row red-red">
        ...
        <div className="col-md-7" id="Container-1">
          <Col>
            <h5 className="Titulo">Información de un contacto en la entidad</h5>
            <label className="label-2">
              {" "}
              Tipo de documento
              <select className="Select-One">
        ...
        <div className="col-md-6" id="Container-1">
          <Col>
            ...
            <label className="label-2">Ingresos operacionales mensuales</label>
        ...
        <div className="col-md-6" id="Container-1">
          <Col>
            <label className="label-18">
              Utilidad neta $ <input type="text" name="" className="Border-2" />
            </label>
          </Col>
        </div>
        ...
        <div className="col-md-12" id="Container-1">
          <Col>
            <label className="label-18">
              Total activos $ <input type="text" name="" className="Border-2" />
            </label>
          </Col>
        </div>
        ...
        <div className="col-md-12" id="Container-1">
          <Col>
            <p className="Texto-3">
              <label className="color">iii)</label> No permitiré el depósito de
              recursos a mis cuentas o a las cuentas de mi representada, por
              parte de terceros producto de actividades ilícitas;{" "}
              ...
              Todo lo anterior de acuerdo con el marco legal aplicable nacional
              e internacional.
            </p>
          </Col>
        </div>
        <div className="col-md-12" id="Container-1">
          <Col>
            ...
            <p className="Texto-3">
              <label className="color">vi)</label> En las cuentas de las cuales
              sea titular mi representada, se manejan recursos públicos de
              naturaleza inembargable:
        ...
        <div className="col-md-12" id="Container-1">
          <Col>
            ...
            <p className="Texto-3">
              ...
              <label className="color">(ii)</label> accedan, recolecten,
              ...
              <label className="color">(iv)</label> compilen y remitan a las
              ...
              <label className="color">(v)</label> consulten multas y sanciones
              ...
              representada; <label className="color">(viii)</label> Consulten,
              ...
              siguientes personas: <label className="color">(a)</label> quienes
              ...
              <label className="color">(j)</label> las personas que estén
              interesadas en la adquisición de cartera de LAS ENTIDADES o que la
              adquieran a cualquier título; <label className="color">(k)</label>{" "}
              las bolsas de valores, administradores de sistemas de negociación
              y registro, a los proveedores de precios, a los organismos de
              autorregulación, los depósitos de valores, entidades que custodian
              valores y demás proveedores de infraestructura del mercado de
              valores, para que recopilen, administren, intercambien información
              entre ellos y la pongan en circulación en el mercado de valores;{" "}
              <label className="color">(l)</label> las entidades de redescuento
              en virtud de las operaciones realizadas con las mismas;{" "}
              <label className="color">(m)</label> a quienes son contratados
              para la realización de actividades de educación financiera;{" "}
              <label className="color">(n)</label> la entidad administradora del
              programa de lealtad de LAS ENTIDADES, para que me contacten o
              ...
              <label className="color"> ii) </label> Compartan mi información o
              ...
              para que LAS ENTIDADES: <label className="color">(a)</label>{" "}
              ...
              <label className="color">(b) </label> Realicen todas las gestiones
              necesarias tendientes a confirmar y actualizar la información mía
              o de mi representada; <label className="color">(c) </label>{" "}
              Validen y verifiquen mi identidad o la de mi representada para el
              ofrecimiento y administración de productos y servicios, así mismo
              para que se compartan la información;{" "}
              <label className="color"> (d) </label> Establezcan, mantengan,
              terminen una relación contractual y actualicen mi información o la
              de mi representada; <label className="color"> (e) </label>{" "}
              Ofrezcan y presten sus productos o servicios a través de cualquier
              medio o canal para mi beneficio y el de mi representada y de
              acuerdo con el perfil de cada uno;{" "}
              <label className="color">(f)</label> Realicen una adecuada
              prestación y administración de los servicios financieros,
              ...
              <label className="color"> Revocatorias. </label> Sin perjuicio de
        ...
        <div className="col-md-12 mb-2" id="Container-1">
          <Col>
            <p className="Texto-3">
              ...
              terroristas; <label className="color">ii) </label> sancionado(s)
              administrativamente por violaciones a cualquier norma
              anticorrupción; <label className="color"> iii) </label>{" "}
              ...
              modalidades; <label className="color">iv) </label> vinculado(s) a
              ...
              <label className="color"> v) </label> Autorizamos a LAS ENTIDADES
              ...
              <label className="color">Producto, costos y tarifas. </label>{" "}
              ...
              <label className="color"> Fogafin. </label> Declaro que me ha sido
              suministrada la información concerniente al seguro de depósitos
              del Fondo de Garantías de Instituciones Financieras FOGAFIN, y que
              la misma está a mi disposición en la página web de LAS ENTIDADES.{" "}
              <br />
              ...
              <br />
              <label className="color">Correspondencia.</label> Autorizo que la
              ...
              <br />
              <label className="color"> Firma y huella. </label> Autorizo a LAS
        ...
        <div className="col-md-12 mb-2" id="Container-1">
          <Col>
            ...
            <p className="Texto-3">
              ...
              sustraigan información; <label className="color">ii)</label>{" "}
        ...
        <div className="col-md-12 mb-2" id="Container-1">
          <p className="Texto-3">
            ...
            Autorizaciones y Declaraciones, en especial la Autorización para el
            Tratamiento de Datos Personales y el derecho a la Revocatoria que me
        ...
        <div className="col-md-9" id="Container-1">
          <p className="Texto-3">
            <label className="Subtitulo"> Concepto Comercial:</label> En virtud
            de haber participado en el proceso de conocimiento del cliente,
            reconozco que soy responsable del completo diligenciamiento de la
            información que ha sido consignada de forma libre en el presente
            formato y con la finalidad que LAS ENTIDADES adelanten dicho
            proceso.
          </p>
          <div>
